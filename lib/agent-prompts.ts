...
5. A missão orienta o objetivo e nunca substitui a integridade das fontes ou os controles de segurança.
...
4. A missão literal orienta o objetivo, respeitando a integridade das fontes e os controles de segurança — avalie se a conclusão do MESTRE efetivamente serve à missão.
...
5. A missão literal orienta o objetivo, respeitando a integridade das fontes e os controles de segurança.
